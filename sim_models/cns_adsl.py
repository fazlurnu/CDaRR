...
This module moved to `legacy.sim_models.cns_adsl` -- it was the frozen
...
`legacy.sim_models.cns_adsl` directly.
'''
from legacy.sim_models.cns_adsl import *  # noqa: F401,F403
