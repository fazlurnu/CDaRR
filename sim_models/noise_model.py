...
This module moved to `legacy.sim_models.noise_model` -- it was the frozen
...
`legacy.sim_models.noise_model` directly.
'''
from legacy.sim_models.noise_model import *  # noqa: F401,F403
