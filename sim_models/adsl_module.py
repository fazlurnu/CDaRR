...
This module moved to `legacy.sim_models.adsl_module` -- it was the frozen
...
`legacy.sim_models.adsl_module` directly.
'''
from legacy.sim_models.adsl_module import *  # noqa: F401,F403
