...
This module moved to `legacy.sim_models.adsl_message` -- it was the frozen
...
`legacy.sim_models.adsl_message` directly.
'''
from legacy.sim_models.adsl_message import *  # noqa: F401,F403
