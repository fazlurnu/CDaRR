...
This module moved to `legacy.sim_models.crr_resumenav_cpa` -- it was the frozen
...
`legacy.sim_models.crr_resumenav_cpa` directly.
'''
from legacy.sim_models.crr_resumenav_cpa import *  # noqa: F401,F403
