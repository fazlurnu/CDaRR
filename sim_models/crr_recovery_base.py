...
This module moved to `legacy.sim_models.crr_recovery_base` -- it was the frozen
...
`legacy.sim_models.crr_recovery_base` directly.
'''
from legacy.sim_models.crr_recovery_base import *  # noqa: F401,F403
