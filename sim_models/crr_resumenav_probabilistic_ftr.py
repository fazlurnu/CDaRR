...
This module moved to `legacy.sim_models.crr_resumenav_probabilistic_ftr` -- it was the frozen
...
`legacy.sim_models.crr_resumenav_probabilistic_ftr` directly.
'''
from legacy.sim_models.crr_resumenav_probabilistic_ftr import *  # noqa: F401,F403
# bare `import *` skips underscore-prefixed names by default; these are
# imported directly by analysis/appendixB/mc_vs_analytical_dcpa.py and
# test/equivalence/test_equiv_prob_math.py.
from legacy.sim_models.crr_resumenav_probabilistic_ftr import _regularize_spd, _to_cov  # noqa: F401
